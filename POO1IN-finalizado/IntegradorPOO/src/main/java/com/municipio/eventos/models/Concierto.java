...
public class Concierto extends Evento {
    ...
    // CAMBIO CLAVE AQUÍ: Eliminar CascadeType.PERSIST
    @ManyToMany(cascade = {CascadeType.MERGE}, fetch = FetchType.LAZY) // Mantener MERGE, añadir LAZY para optimización
    @JoinTable(
    ...
    public void agregarArtista(Artista artista) {
        if (artista != null && !artistas.contains(artista)) {
            ...
            // artista.addConcierto(this); // <--- Esto es lo que se podría añadir si la relación fuera bidireccional en Artista
        }
    }
